...
export const UserSubscribers = ({
  ...
  return (
    <div data-mobile={isMobile} className="flex flex-col px-4 pb-safe data-[mobile=true]:pt-32">
      <div
      ...
      {filteredSubscribers && filteredSubscribers.length > 0 ? (
              ...
              >
                <div className="flex items-center justify-start gap-3">
                  ...
                  <div className="flex flex-col gap-0.5">
                    ...
                    <div className="text-xs font-medium text-gray-500">{subscriber?.birthday}</div>
                  </div>
                </div>
              </motion.div>
            );
        ...
        <div className="flex flex-col items-center justify-center py-20">
          ...
          <div className="text-center text-gray-500">
            ...
            <p className="text-sm text-gray-500">У этого пользователя пока нет подписчиков</p>
          </div>
        </div>
      )}
    </div>
