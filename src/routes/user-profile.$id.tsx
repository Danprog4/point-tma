...
function RouteComponent() {
  ...
  const handleRefresh = async () => {
    ...
    if (!accessData?.hasAccess && user?.isPrivate) return;
                      ...
                      >
                        ...
                        {isLocked && (
                            <div className="absolute inset-0 z-30 flex flex-col items-center justify-center bg-black/40 backdrop-blur-md">
                                <div className="mb-4 rounded-full bg-white/20 p-6 backdrop-blur-xl">
                                    <Lock className="h-12 w-12 text-white" />
                                </div>
                                <h3 className="mb-2 text-2xl font-bold text-white">Профиль закрыт</h3>
                                <p className="mb-8 max-w-[280px] text-center text-sm font-medium text-white/90">
                                ...
                                <button
                                    ...
                                    className="rounded-2xl bg-white px-8 py-3.5 font-bold text-black transition-transform active:scale-95 disabled:opacity-50"
                                >
                            ...
                            {(() => {
                              ...
                              return (
                                <div
                                  ...
                                  onClick={() => !isLocked && setIsLevelModalOpen(true)}
                                >
                                  <svg
                                    width={size}
                                    height={size}
