...
export const Header = () => {
  ...
  return (
    ...
    >
      <div className="absolute left-2 flex w-30 items-center gap-4">
        <div className="flex items-center">
          <img src="/logo.png" alt="logo" className="h-30 w-30 object-contain" />
        </div>
      </div>
      <div className="flex w-20 items-center gap-4">
        <Logo />
      </div>
      <div className="ml-5 flex items-center gap-2 rounded-full bg-white px-3 py-1.5 shadow-sm ring-1 ring-black/5">
        <Coin />
